...
urlpatterns = [
    ...
    url(r'^imagen/detalle/(?P<pk>\d+)/$', ImagenDetail.as_view(), name='imagen_detalle'),
    url(r'^imagen/editar/(?P<pk>\d+)/$', ImagenUpdate.as_view(), name='imagen_editar'),
    url(r'^imagen/eliminar/(?P<pk>\d+)/$', ImagenDelete.as_view(), name='imagen_eliminar'),
